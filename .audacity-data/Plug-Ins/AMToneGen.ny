...
;control am-depth "Modulation Depth" real "0 to 1" 1 0 1
;;control fm-width "FM width (deviation)" real "Hz" 10 0 100
;control duration "Duration" real "seconds" 10 0 100
;control gain "Amplitude" real "0 to 1" 0.8 0 1

;; AMToneGen.ny by Steve Daulton April 2013,
...
(if (not (boundp 'mod-type))
    (setq mod-type 0)) ; Amplitude Modulation
