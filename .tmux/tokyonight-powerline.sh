...
set "status-right" "#[fg=$tokyonight_green,bg=$tokyonight_black]#(~/code/,claude/claude-usage-tmux/scripts/claude_usage.sh)  #[fg=$tokyonight_white,bg=$tokyonight_black,nounderscore,noitalics]#{playerctl_full} ${date_format} ${time_format} #[fg=$tokyonight_visual_grey,bg=$tokyonight_black]#[fg=$tokyonight_visual_grey,bg=$tokyonight_visual_grey]#[fg=$tokyonight_white, bg=$tokyonight_visual_grey]${status_widgets} #[fg=$tokyonight_blue,bg=$tokyonight_visual_grey,nobold,nounderscore,noitalics]#[fg=$tokyonight_black,bg=$tokyonight_blue,bold] #h #[fg=$tokyonight_yellow, bg=$tokyonight_blue]#[fg=$tokyonight_black,bg=$tokyonight_yellow]#{pomodoro_status}#[fg=green]#($TMUX_PLUGIN_MANAGER_PATH/tmux-mem-cpu-load/tmux-mem-cpu-load --colors --powerline-right --interval 2)"
